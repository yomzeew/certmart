...
export default function App() {
  ...
  return (
    <PaperProvider>
      ...
      <Stack.Screen options={{gestureEnabled:true,gestureDirection: 'vertical',}} name="onboarding" component={StackWrapper}/> 
      <Stack.Screen options={{gestureEnabled:false,gestureDirection: 'vertical',}} name="dashboard" component={DrawerWrapper}/>      
        </Stack.Navigator>
