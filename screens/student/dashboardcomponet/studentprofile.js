                    ...
                    <View className="h-full  bg-slate-100 rounded-2xl px-3">
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View className="mt-5 w-full flex-row items-center  flex justify-between">
                                <Text style={{ fontSize: 14 }} className="text-slate-500">Surname: {Surname}</Text>
                                <Text style={{ fontSize: 14 }} className="text-slate-500">Firstname: {Firstname}</Text>

                            </View>
                            <Divider />
                            <View className="mt-3 w-full flex-row items-center  flex justify-between">
                                <Text style={{ fontSize: 14 }} className="text-slate-500">Middlename: {Middlename}</Text>
                                <Text style={{ fontSize: 14 }} className="text-slate-500">Gender: {Gender}</Text>
                            ...
                            <View className="mt-5 flex  flex-row justify-between">
                                ...
                                <TouchableOpacity onPress={handleAddress}><FontAwesome color={colorred} size={20} name="pencil" /></TouchableOpacity>
                            ...
                            <View className="mt-5 flex  flex-row justify-between">
                                ...
                                <TouchableOpacity onPress={handleContact}><FontAwesome color={colorred} size={20} name="pencil" /></TouchableOpacity>
                            ...
                            <Divider />
                            <View className="mt-3 w-full">
                                <Text style={{ fontSize: 14 }} className="text-slate-500">Email: {Email}</Text>
                            </View>
                            <View className="mt-5 flex  flex-row justify-between">
                                <Text style={{ fontSize: 16 }} className="font-bold">Next of Kin's Details</Text>
                                <TouchableOpacity onPress={handleNOK}><FontAwesome color={colorred} size={20} name="pencil" /></TouchableOpacity>
